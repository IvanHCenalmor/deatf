...
if __name__ == "__main__":
    ...
    e = Evolving(loss="XEntropy", desc_list=[MLPDescriptor], x_trains=[x_train], y_trains=[y_train], x_tests=[x_test], y_tests=[y_test], evaluation="Accuracy_error", n_inputs=[[28, 28]], n_outputs=[[10]], batch_size=150, population=30, generations=10, iters=1000, n_layers=10, max_layer_size=20)
    a = e.evolve()
