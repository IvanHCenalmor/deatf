...
from Network import ConvDescriptor
...
def test_CNN_all_datasets(eval_func=None, batch_size=150, population=5, 
    ...
    for dataset in dataset_collection:
        ...
        try:
            x = test_CNN(dataset, eval_func=None, batch_size=batch_size, 
...
if __name__ == "__main__":
    test_CNN('omniglot', eval_func=eval_cnn, batch_size=150, population=2, generations=2, iters=10)
    #test_CNN_all_datasets(eval_func=eval_cnn, batch_size=150, population=2, generations=2, iters=10)