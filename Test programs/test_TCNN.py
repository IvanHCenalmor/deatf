...
from Network import TConvDescriptor
...
if __name__ == "__main__":
    #test_TCNN('rock_paper_scissors', eval_func=eval_tcnn, batch_size=150, population=3, 
    #         generations=2, iters=100, n_layers=10, max_layer_size=20)
